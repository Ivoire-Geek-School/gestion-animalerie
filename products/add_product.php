          ...
          <form method="post" action="../products/add_product.php" class="clearfix">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-sku" value="" placeholder="Race">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-location" value="" placeholder="Weight">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
