    ...
    <form method="post" action="ajax_product.php" autocomplete="off" id="sug-search-form">
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" id="sug_search_input" class="form-control" name="product_search"  placeholder="Product Name / Race / Description">
         </div>
        ...
        <form method="post" action="">
         <table class="table table-bordered">
           ...
           <thead>
                <th> Product Name </th>
                <th> Photo</th>
                <th class="text-center" style="width: 10%;"> Race </th>
                <th class="text-center" style="width: 10%;"> Weight </th>
                <!-- <th class="text-center" style="width: 10%;"> Cut </th>
                <th class="text-center" style="width: 10%;"> Fourrure </th>
                <th class="text-center" style="width: 10%;"> Noise </th> -->
