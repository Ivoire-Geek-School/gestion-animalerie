           ...
           <form method="post" action="../products/edit_product.php?id=<?php echo (int)$product['id'] ?>">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-sku" value="<?php echo remove_junk($product['sku']);?>" placeholder="Race">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-location" value="<?php echo remove_junk($product['location']);?>" placeholder="Weight">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="cut"  placeholder="Cut">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="fourrure"  placeholder="Fourrure">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="noise"  placeholder="Noise">
               </div>
              </div>
              <div class="form-group">
                <div class="row">
